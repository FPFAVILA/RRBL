            ...
            <div className="space-y-4">
              ...
              <div className="bg-accent/10 rounded-xl p-4 border border-accent/30">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    { value: suggestedAmount && suggestedAmount >= 4.90 ? suggestedAmount.toFixed(2).replace('.', ',') : '9,80', games: suggestedAmount && suggestedAmount >= 4.90 ? 'Próximo jogo' : '2 jogos', popular: true },
